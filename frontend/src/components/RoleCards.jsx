        ...
        <Tilt tiltMaxAngleX={15} tiltMaxAngleY={15} glareEnable={true} glareMaxOpacity={0.2}>
          ...
          >
            ...
            <p className="text-sm text-gray-700 text-center px-2">
              I'm a fresher and passionate full stack developer skilled in MERN, PHP, and web design. I'm a 2025 pass-out, eager to start my professional journey. Thank you for visiting my portfolio!
            </p>
