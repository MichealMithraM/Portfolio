...
const projects = [
  ...
  {
    title: 'E-Certificate generater',
    description: 'Developed a React.js E-Certificate Generator with PDF download.',
    path: '/projects/admin-panel',
    url: 'http://lighthearted-douhua-004c32.netlify.app',
  },
  {
    title: 'E-Commerce Dress Store',
    description: 'A sample responsive E-Commerce app with cart, checkout, and admin updates.',
    path: '/projects/admin-panel',
    url: 'https://dress-store.netlify.app',
  },
  {
    title: 'Contract Extractor',
    description: 'Developed a React.js Contract Extractor web app for extracting and managing contract details.',
    path: '/projects/admin-panel',
    url: 'https://contract-extractor.vercel.app',
  },
  {
    title: 'CRM Software',
    description: 'A PHP-based CRM application for managing leads, customers, and workflows.',
    path: '/projects/admin-panel',
    url: 'https://crm-demo.page.gd/?i=1',
  },
  {
    title: 'Restaurant Management System',
    description: 'MERN-based MealMate web application with four user roles: Manager, Cashier, Chef, and Waiter',
  ...
  },
  {
    ...
    url: 'https://news-paper-billing-3fsh.vercel.app/',
  },
  {
    title: 'Clock App',
