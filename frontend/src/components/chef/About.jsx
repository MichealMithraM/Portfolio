        ...
        <main className="flex-1 overflow-y-auto px-6 py-8 md:px-16 bg-gradient-to-br from-white to-yellow-50">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p>
                BE (CSE) graduate - 2025 passout with real-time project experience in web development. Strong skills in web designing and frontend development. Currently working on a live .NET project and gaining hands-on experience in .NET and ASP.NET. Quick learner with the ability to adapt to new technologies, especially when guided. Experienced in building and deploying live websites and skilled in using AI tools to complete tasks efficiently. Eager to contribute to professional and innovative projects.

              </p>
              <p className="text-gray-700">
                 My development journey began with HTML and CSS, later progressing to React and Node.js, and now expanding into .NET and ASP.NET. I enjoy blending logic with design to create engaging web experiences.
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                <li><strong>Frontend:</strong> HTML, CSS, JavaScript, React.js, Tailwind css, Responsive UI.</li>
                <li><strong>Backend:</strong> Node.js, Express.js, .Net, Asp.Net, Php</li>
                <li><strong>Tools:</strong> GitHub, VS Code, Visual Studio Management</li>
                <li><strong>DataBase:</strong> SQL Server Management, Mongo DB, Xampp, MySQL</li>
              </ul>
