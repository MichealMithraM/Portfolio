...
const cardData = [
  {
    ...
    content: 'React, Node.js, Express, MongoDB, Tailwind CSS, HTML, CSS, JavaScript, .NET'
  },
  {
    title: 'Projects',
    ...
    content: (
      <ul className="list-disc list-inside space-y-1 text-sm text-gray-600">
        ...
        <li>CRM (PHP/XAMPP)</li>
        <li>E-Certificate generater (React.js) </li>
        <li className="font-semibold text-yellow-700">E-Commerce Dress Store</li>
      </ul>
    )
  },
  {
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
        <li>Indian Knowledgement System </li> 
        <li>Doozy Info Software Solutions </li>
        {/* <li>Life Changes – Restaurant System</li> */}
       
        <li className="font-semibold text-yellow-700">Samudhra Tech Solutions <b>- Present</b></li>
      </ul>
    )
  },
  {
